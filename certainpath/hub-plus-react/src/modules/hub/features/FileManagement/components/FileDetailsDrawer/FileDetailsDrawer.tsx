// src/modules/hub/features/FileManagement/components/FileDetailsDrawer/FileDetailsDrawer.tsx
...
import styles from "./FileDetailsDrawer.module.css";
...
const FileDetailsDrawer: React.FC<FileDetailsDrawerProps> = ({
  ...
  useEffect(() => {
    ...
    // When drawer closes, reset the details
    return () => {
      if (!isOpen) {
        setNodeDetails(null);
      }
      ...
      return (
        <div className={styles.section}>
          <h4 className={styles.sectionTitle}>
            <ImageIcon className={styles.sectionIcon} size={18} />
            Preview
          </h4>
  ...
  const renderDuplicates = () => {
    ...
    return (
      <div className={styles.section}>
        <h4 className={styles.sectionTitle}>
          <Copy className={styles.sectionIcon} size={18} />
  ...
  const renderUsages = () => {
    ...
    return (
      <div className={styles.section}>
        <h4 className={styles.sectionTitle}>
          <Link className={styles.sectionIcon} size={18} />
                    ...
                    <div className={styles.body}>
                      {isLoading ? (
                        <div className={styles.loadingContainer}>
                          <Loader2 className={styles.spinningIcon} size={48} />

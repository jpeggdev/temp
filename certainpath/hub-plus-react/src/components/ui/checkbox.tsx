  ...
  "peer group shrink-0 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:stroke-primary-foreground",
  {
    variants: {
      color: {
        ...
        // New blue gradient variant that matches the header styling
        "blue-gradient":
          "border border-default-400 data-[state=checked]:border-[#2563eb] data-[state=checked]:bg-gradient-to-br data-[state=checked]:from-[#3b82f6] data-[state=checked]:to-[#2563eb] transition-all duration-200 ease-in-out",
        destructive:
    ...
    compoundVariants: [
      ...
      },
      {
        variant: "outline",
        color: "blue-gradient",
        className: "[&_svg]:stroke-white border-[#3b82f6]",
      },
      {

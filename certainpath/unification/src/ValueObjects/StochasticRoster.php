    ...
    public function __construct(
        ...
        foreach ($reader->getSheetIterator() as $sheet) {
            ...
            foreach ($sheet->getRowIterator() as $row) {
                ...
                $dto->electricalLifeFileName = (string) $cells[20]->getValue();
                $dto->plumbingLifeFileName = (string) $cells[21]->getValue();
                $dto->hvacLifeFileName = (string) $cells[22]->getValue();
                $dto->lifeFolderName = (string) $cells[23]->getValue();
                $this->roster[] = $dto;
            }
        }
    }
